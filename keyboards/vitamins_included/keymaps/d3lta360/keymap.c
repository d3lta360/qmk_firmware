 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Sys |  Alt |  Fn  |Lower |  Fn  |Space |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_ortho_4x12( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, NAV,     LOWER,   NAV,     KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_ADJUST] = LAYOUT_ortho_4x12( \
  ...
  TG_NKRO, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_MOD  \
)
